...
public class EmailSender {
    ...
    private static final String PASSWORD = "ykvf uyoa xkpg fwhx";
...
//            String resetLink = ConfigUtils.get("app.url") + "/forgot-password?token=" + resetToken;
            String resetLink = "http://192.168.217.129" + "/forgot-password?token=" + resetToken;
